            ...
            <div class="footer-widgets">
                ...
                <div class="footer-widget">
                    ...
                    <div class="contact-details">
                        <p class="address"><?php echo esc_html(get_theme_mod('contact_address', '56 Điện Biên Phủ - Phường Trường An - TP Huế')); ?></p>
                        <p class="hotline"><?php esc_html_e('Hotline:', 'dulichvietnhat'); ?> <a href="tel:0367722389">0357600007</a></p>
                        <p class="email"><?php esc_html_e('Email:', 'dulichvietnhat'); ?> <a href="mailto:info@dulichvietnhat.vn">thanhchau1fd@gmail.com</a></p>
                        <div class="office-branch">
                            <p class="office-title"><?php esc_html_e('Văn phòng Hà Nội', 'dulichvietnhat'); ?></p>
                            <p class="office-address"><?php echo esc_html(get_theme_mod('office_vungtau', '102 Điện Biên Phủ')); ?></p>
                        </div>
                    </div>
                </div>
    ...
    <div class="footer-bottom">
        <div class="container">
            <div class="footer-bottom-inner">
                <div class="copyright">
                    <?php esc_html_e('© Copyright Du Lịch Toàn Quốc', 'dulichvietnhat'); ?>
                </div>
