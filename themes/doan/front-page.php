        ...
        <div class="container">
            <div class="section-header">
                <h2 class="section-title">
                    <?php echo esc_html( get_theme_mod('featured_section_title', 'Về Tiêu Đề Chung') ); ?>
                </h2>
                <p>
                    <?php echo esc_html( get_theme_mod('featured_section_subtitle', 'Trải Nghiệm Du Lịch Không Thể Bỏ Lỡ') ); ?>
                </p>
            </div>
            ...
            <div class="contact-form-wrapper">
                <div class="contact-form-content">
                    <div class="section-header">
                        ...
                        <p>Điền thông tin để nhận tư vấn miễn phí về tour du lịch toàn quốc</p>
                    </div>
                    ...
                    <div class="contact-info">
                        ...
                        <div class="contact-item">
                            ...
                            <div class="contact-details">
                                <h4>Địa chỉ</h4>
                                <p>56 Điện Biên Phủ - Phường Trường An - TP Huế</p>
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select id="contact_tour" name="contact_tour">
                                            ...
                                            <option value="trungquoc">Tour Trung Quốc</option>
                                            <option value="phap">Tour Pháp</option>
                                            <option value="nhat">Tour Nhật</option>
                                            <option value="han">Tour Hàn</option>
